      ...
      <article className="max-w-[680px] mx-auto">
        ...
        <div className="border border-ink/15 px-6 py-5 mb-12">
          <p className="text-[13px] leading-[1.7] text-slate">
            ...
            Manhattanite is in its private, seed phase. We&rsquo;ll publish a final
        ...
        <p className={P}>
          ...
          manual approval, and it&rsquo;s what lets you post listings, contact other
        ...
        <p className={P}>
          ...
          or lawful source of income. New York&rsquo;s protections are broad, and we
        ...
        <p className={P}>
          ...
          doesn&rsquo;t limit any rights that can&rsquo;t be limited under applicable
          law.
        </p>
